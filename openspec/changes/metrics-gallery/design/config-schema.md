...
| ------- | ------ | -------- | ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| _(key)_ | string | Yes      | Pattern: `^[a-z0-9-]+$`, Length: 1-64 chars | Object key serves as the unique metric identifier, used in thresholds, database storage, and internal references |
...
```
Error: Threshold references non-existent metric "loc".
